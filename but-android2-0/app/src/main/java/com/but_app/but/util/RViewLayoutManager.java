...
import com.but_app.but.BuildConfig;

public class RViewLayoutManager extends android.support.v7.widget.LinearLayoutManager {
    ...
    public RViewLayoutManager(Context context) {
        super(context);
    }

    @SuppressWarnings("UnusedDeclaration")
    public RViewLayoutManager(Context context, int orientation, boolean reverseLayout) {
